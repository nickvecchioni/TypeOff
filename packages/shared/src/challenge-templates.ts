export interface ChallengeTemplate {
  title: string;
  description: string;
  metric: "wpm" | "races" | "wins" | "accuracy" | "streak";
  target: number;
}
...
export const DAILY_TEMPLATES: ChallengeTemplate[] = [
  ...
  { title: "Precision", description: "Achieve 95%+ accuracy in a race", metric: "accuracy", target: 95 },
...
export const WEEKLY_TEMPLATES: ChallengeTemplate[] = [
  ...
  { title: "Perfectionist", description: "Achieve 100% accuracy in a race", metric: "accuracy", target: 100 },
