...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={`${jetbrainsMono.variable} font-mono antialiased h-screen flex flex-col overflow-y-auto`}>
        <SessionProvider>
          <SettingsProvider>
          <CosmeticProvider>
          <SocketProvider>
          ...
          <UsernameGuard>
            ...
            <footer className="focus-fade relative z-10 shrink-0 flex items-center justify-center gap-3 py-3 text-sm text-muted/80">
