    ...
    <main className="flex-1 overflow-y-auto px-4 sm:px-6 py-8">
      <div className="max-w-3xl mx-auto space-y-4 animate-fade-in">
        ...
        <div className="rounded-xl bg-surface/40 ring-1 ring-white/[0.04] overflow-hidden">
          {/* Header */}
          <div className="grid grid-cols-[2.5rem_1fr_5rem_4rem_4rem] text-xs text-muted/50 uppercase tracking-wider px-4 py-2 border-b border-white/[0.06]">
            <span>#</span>
            <span>Clan</span>
            ...
            topClans.map((clan, i) => {
              ...
              return (
                <Link
                  key={clan.id}
                  href={`/clans/${clan.id}`}
                  className="grid grid-cols-[2.5rem_1fr_5rem_4rem_4rem] items-center px-4 py-2.5 border-b border-white/[0.03] last:border-0 hover:bg-white/[0.02] transition-colors"
                >
