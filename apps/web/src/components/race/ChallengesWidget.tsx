...
export function ChallengesWidget() {
  ...
  if (!data) {
    return (
      <div className="w-full rounded-xl bg-surface/50 ring-1 ring-white/[0.04] p-5 animate-pulse">
        <div className="h-4 bg-white/[0.04] rounded w-32 mb-4" />
  ...
  return (
    <div className="w-full rounded-xl bg-surface/50 ring-1 ring-white/[0.04] p-5 space-y-4">
      {/* XP Level */}
