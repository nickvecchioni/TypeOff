    ...
    <div className="flex flex-col items-center gap-8 sm:gap-10 animate-fade-in w-full">
      ...
      {session?.user ? (
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 rounded-lg bg-accent text-bg px-8 sm:px-14 py-4.5 text-base font-bold tracking-wide uppercase hover:bg-accent/90 transition-colors glow-accent-strong w-full sm:w-auto"
        >
