...
export function RaceResults({ results, myPlayerId, onRaceAgain, placementRace, placementTotal }: RaceResultsProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-8 w-full">
      ...
      <button
        onClick={() => onRaceAgain()}
        className="rounded-xl border border-accent/30 bg-accent/15 text-accent px-8 py-3 font-bold hover:bg-accent/25 hover:border-accent/50 hover:shadow-[0_0_24px_rgba(122,162,247,0.2)] transition-all duration-200"
      >
